...
class PurchaseLinearRegression(PurchaseMLModel):
    ...
    def predictPriceFromGenderAndAge(self, gender, age):
        """
        Hàm này chỉ là wrapper: gọi lại hàm 3 tham số
        và giả sử payment_method mặc định là 'Cash'
        (em thích thì đổi thành 'Credit Card' cũng được).
        """
        return self.predictPriceFromGenderAndAgeAndPayment(gender, age, "Cash")
